        ...
        <div>
            <div className="flex items-center justify-between w-full gap-2">
                ...
                <div className="flex items-center py-4 w-full">
                    {/* Filtro por reservable (Es un objeto) asi que buscampos por el nombre del objeto */}
                    <Input
                        placeholder="Buscar por espacio"
                        value={(table.getColumn("reservable")?.getFilterValue() as string) || ""}
                        onChange={(event) =>
                            table.getColumn("reservable")?.setFilterValue(event.target.value)
                        }
